...
#define MY_PLUGIN_NAME      "FlyByIT vSMR"
#define MY_PLUGIN_VERSION   "1.0"
#define MY_PLUGIN_DEVELOPER "Edited by FlyByIT | Source Authors: Pierre Ferran, Even Rognlien, Lionel Bischof, Daniel Lange, Juha Holopainen, Keanu Czirjak"
